...
export default class CancelledOrders {
  constructor() {
    document.title = "Cancelled Orders - Send IT - Send Orders Anywhere | Timely Delivery | Real Time Tracking";
  ...
  listOrders(props = {}) {
    ...
    parcels = parcels.filter(item => item.status === 'cancelled');
              ...
              <div class="column col-9 page-right">
                ...
                <div class="main-content">
                  <div class="container">
                    ...
                    <div class="header"><span>Orders <strong>Cancelled Delivery</strong></span></div>
